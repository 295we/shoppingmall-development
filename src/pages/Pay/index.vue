    ...
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="otherpay">
          ...
          <div class="step-cont">
            <span><a href="weixinpay.html" target="_blank">支付宝支付</a></span>
            <span>中国银联</span>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    async open() {
      ...
      this.$alert(`<img src='${url}'></img>`, '请微信扫码献出你的元子', {
        dangerouslyUseHTMLString: true,
        center: true,
        showCancelButton: true,
        showClose: false,
        cancelButtonText: '没钱不买了',
        ...
        beforeClose: (type, instance, done) => {
          if (type == 'cancel') {
            ...
            if (this.payCode == 200) {
              // 没有点击confirm或者啥也没点击 但是只要满足200，就跳转路由
              clearInterval(this.timer);
              this.timer = null;
              done();
